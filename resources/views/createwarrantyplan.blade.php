...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        <div class="card-header">{{ __('Add Warranty Plan') }}</div>
        <div class="card-body">
          <form method="POST" action="/createwarranty">
            @csrf
			
            <div class="row mb-3">
              <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Name') }}</label>
              <div class="col-md-6">
                <input id="plan_name" type="text" class="form-control @error('plan_name') is-invalid @enderror" name="plan_name"  autocomplete="plan_name" required>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <input id="days_warranty" type="number" class="form-control @error('days_warranty') is-invalid @enderror" name="days_warranty"  required >
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <select id="warranty_start" class="form-control" name="warranty_start" >
                  <option value="Delivery day" >Delivery day</option>
                  <option value="invoice emitting day" >Invoice emitting day</option>
                  <option value="manual day set" >Manual day set</option>
                </select>
              </div>
            </div>
            <div class="row mb-0">
